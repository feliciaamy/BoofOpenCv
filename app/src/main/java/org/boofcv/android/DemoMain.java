...
import org.boofcv.android.localization.BoxDetectorActivity;
import org.boofcv.android.localization.CameraActivity;
import org.boofcv.android.localization.CaptureCameraImage;
import org.boofcv.android.localization.LocalizationActivity;
...
public class DemoMain extends Activity implements ExpandableListView.OnChildClickListener {
    ...
    private void createGroups() {
        ...
        Group localization = new Group("Localization");
...
//		tracker.addChild("Point: Combined", CombinedTrackerDisplayActivity.class);
        ...
        localization.addChild("Color Detector", LocalizationActivity.class);
        localization.addChild("Box Detector", BoxDetectorActivity.class);
        localization.addChild("Capture Image", CaptureCameraImage.class);
        localization.addChild("Camera Intent", CameraActivity.class);
